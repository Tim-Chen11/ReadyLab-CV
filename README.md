...
scripts: 1. analyze_dataset, create_splits, feature_cluster for generate the json data for future trainning. e.g. processed_metadata.py in data folder 2. setup_pipeline is the main logic that combines all the above for data clean and generation 3. train.py is the main logic for starting the training process
